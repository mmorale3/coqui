...
if len(sys.argv) == 3:
    ...
    Converter = Wannier90Converter(seedname=arg1, rot_mat_type='hloc_diag', bloch_basis=True, w90zero=1e-5)
## perform the conversion
Converter.convert_dft_input()

# execute using:
# mpirun python w90_convert_bloch.py seedname > conv.out 2> conv.err &
