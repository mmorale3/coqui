...
paw_convergence_B.{pdf,png} and prints per-(PP,nbnd) LaTeX tables.
...
for col, key in enumerate(("relVH", "relVX")):
    ...
    # clean x ticks: plain integer labels, no crowded minor-tick labels
...
fig.tight_layout()
fig.savefig("paw_convergence_B.pdf"); fig.savefig("paw_convergence_B.png", dpi=150)
print("wrote paw_convergence_B.pdf")
