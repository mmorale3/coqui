...
paw_convergence_w150.{pdf,png} and prints per-(PP,nbnd) LaTeX tables.
...
fig.tight_layout()
fig.savefig("paw_convergence_w150.pdf"); fig.savefig("paw_convergence_w150.png", dpi=150)
print("wrote paw_convergence_w150.pdf")
