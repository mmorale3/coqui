...
% DATA PROVENANCE -- DO NOT SUBMIT AS IS.
% The numbers and figure in this subsection (si_rpa_paper.pdf, si_rpa_vs_k.pdf,
% si_rpa_proj.csv) were generated 2026-06-12, before the V_LL transpose fix of
% 2026-07-29 (commit 86ace47). That defect was in the augmentation path, so the
% ultrasoft and PAW values quoted below (-0.446 and -0.448 Ha) are affected,
% while the two norm-conserving ones are not -- i.e. exactly the comparison this
% subsection rests on. Regenerate on the fixed code before submission.
