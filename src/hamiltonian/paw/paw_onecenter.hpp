...
inline nda::array<ComplexType,3> pseudopot::compute_deeq_scf(nij_t const& nij)
{
    ...
    // spin factor) lives in the compute_paw_deeq nij overload.
...
// core. ns_scl carries CoQui's spin doubling for nspin=1;
// compute_becsum_{diagonal,full} both
